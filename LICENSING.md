...
NFON Call Monitor is **source-available** software, licensed under the
...
| Build and run it to monitor **your own** phone system / your own organization's | ✅ Yes |
...
| Use case | Allowed under BSL? |
| --- | --- |
| Offer NFON Call Monitor to **third parties** as a hosted / managed / multi-tenant service | ❌ Needs a commercial license |
| Monitor **your customers'** phone systems with it as a paid service (MSP use) | ❌ Needs a commercial license |
...
NFON Call Monitor is how STYLiTE funds its development. BSL lets us keep both:
open source you can run yourself, with the commercial-service rights reserved to
STYLiTE until each version ages into full GPLv3.
...
"STYLiTE" is a trademark of STYLiTE AG. "NFON" is a trademark of NFON AG and is
used here only to describe compatibility; this project is not affiliated with or
endorsed by NFON AG. The BSL grants no rights to any names or logos — a permitted
fork must be distributed under a different name.
