...
# Release script for NFON Call Monitor
...
echo "  - docker.io/styliteag/nfon-call-monitor:$NEW_VERSION"
echo "  - docker.io/styliteag/nfon-call-monitor:latest"
echo "  - ghcr.io/styliteag/nfon-call-monitor:$NEW_VERSION"
echo "  - ghcr.io/styliteag/nfon-call-monitor:latest"
echo ""
